...
import softwareDeveloper from '../assets/Lovepik_com-450092792- illustration of software development male developer.png';
import dataAnalyst from '../assets/—Pngtree—cool illustration of businessman and_6006379.png';
import profilePic from '../assets/imagec-1.png';
        ...
        {showMainContent && (
          <>
            <div className="pt-20 flex-grow">
              ...
              <div className="container-fluid min-h-[80vh] flex flex-col justify-center relative overflow-hidden">
                <div className="flex flex-col md:flex-row items-center justify-center">
                  ...
                  <div className="md:w-1/6 text-center py-10 md:py-0 z-10">
                    <h1 className="text-xl font-bold text-foreground dark:text-white">Hey, this is Biswadeep</h1>
              ...
              <div
                ref={introSectionRef}
                className={`container-fluid py-16 bg-background backdrop-blur-sm rounded-lg transition-opacity duration-1000 ${showIntro ? 'opacity-100' : 'opacity-0'}`}
              >
